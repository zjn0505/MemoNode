  ...
  http.onreadystatechange = function() {
    if(http.readyState == 4 && http.status == 200) {
        ...
        if (json.result == 200) {
          ...
          alertSuccess.innerHTML = "<strong>Success!</strong> You have created a memo with id <span style='font-family: monaco, Consolas, 'Lucida Console', monospace;'><a href='https://pullsh.me/"+json.memo._id+"'>"+json.memo._id+"</a></span>.";
  ...
  http.onreadystatechange = function() {
    if(http.readyState == 4 && http.status == 200) {
        ...
        if (json.result == 200) {
          ...
          $('#modal-title').html("Memo Id : <span style='font-family: monaco, Consolas, 'Lucida Console', monospace;'><strong>" + json.memo._id + "</strong></span>");
...
function rebuildTable() {
  ...
  for (var key in json) {
    if (json.hasOwnProperty(key)) {
      ...
      cellId.innerHTML = "<span style='font-family: monaco, Consolas, 'Lucida Console', monospace;'><a href='https://pullsh.me/" + json[key].memo._id + "'>" + json[key].memo._id + "</a></span>";
